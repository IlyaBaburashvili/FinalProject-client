    ...
    <div className={classes.root}>
      <div className={classes.formContainer}>
        ...
        <form style={{textAlign: 'center'}} onSubmit={(e) => handleSubmit(e)}>
          ...
          <input type="text" name="name" onChange ={(e) => handleChange(e)} onBlur={(e) =>{
            if(!e.target.value){
          ...
          <input type="text" name="address" onChange={(e) => handleChange(e)} onBlur={(e) =>{
            if(!e.target.value){
          ...
          <input type="text" name="description" onChange={(e) => handleChange(e)} onBlur={(e) =>{
            if(!e.target.value){
